...
RUN wget https://github.com/Graylab/GeoDock/archive/refs/heads/main.zip && \
  unzip main.zip
RUN wget -q -P /root/.cache/torch/hub/checkpoints https://dl.fbaipublicfiles.com/fair-esm/models/esm2_t33_650M_UR50D.pt
RUN wget -q -P /root/.cache/torch/hub/checkpoints https://dl.fbaipublicfiles.com/fair-esm/regression/esm2_t33_650M_UR50D-contact-regression.pt
